...
const CONFIG = {
  ...
  journeyMode: envValue("PANTHEON_JOURNEY_MODE", "production"),
  journeyBudgetCapCents: Math.max(
    100,
    Math.round(numberFromEnv("PANTHEON_JOURNEY_BUDGET_CAP_AUD", 30) * 100),
  ),
