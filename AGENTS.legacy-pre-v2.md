# LEGACY PRE-V2 AGENT INSTRUCTIONS

Historical reference only.

This file is not authoritative for current Codex or Claude development.
Current instructions are in `/AGENTS.md`.
Do not automatically import requirements from this file.
